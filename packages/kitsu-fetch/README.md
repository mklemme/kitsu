<h1 align=center>Kitsu Fetch</h1>

<p align=center>
  <a href=https://www.npmjs.com/package/kitsu-fetch><img alt=npm src=https://flat.badgen.net/npm/v/kitsu-fetch></a>
  <a href=https://www.npmjs.com/package/kitsu-fetch><img alt=npm src=https://flat.badgen.net/npm/dt/kitsu-fetch></a>
  <a href="https://bundlephobia.com/result?p=kitsu-fetch"><img alt=bundlephobia src=https://flat.badgen.net/bundlephobia/minzip/kitsu-fetch></a>
  <a href="https://david-dm.org/wopian/kitsu?path=packages/kitsu-fetch"><img alt=deps src="https://flat.badgen.net/david/dep/wopian/kitsu/packages/kitsu-fetch"></a>
</p>

<p align=center>
  <a href=https://travis-ci.com/wopian/kitsu><img alt=travis src=https://flat.badgen.net/travis/wopian/kitsu></a>
  <a href="https://packagephobia.now.sh/result?p=kitsu-fetch"><img alt=packagephobia src=https://flat.badgen.net/packagephobia/install/kitsu-fetch></a>
...
| ------------: | :----------------: | :--: | :----: | :-----: | :----: | :--: |
| `kitsu-fetch` |      ≤ 6.2 kb      |  10+ |   69+  |   68+   |   12+  |  18+ |
